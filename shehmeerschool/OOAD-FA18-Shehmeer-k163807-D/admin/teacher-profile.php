...
<body>
    <nav class="navbar navbar-expand-sm sticky-top navbar-light bg-light mb-3">
        <div class="container">
            <a href="configure-teaching-staff.php" class="mr-4"><i class="fas fa-arrow-left fa-2x text-dark"></i></a>
    ...
    <section id="add-teaching-staff" class="py-5">
        <div class="container">
            <div style="width:75%;" class="m-auto bg-light p-5">
                ...
                $row = $res->fetch_assoc();
                ?>
                <h1 class="display-4 text-center mb-4">Teacher Information</h1>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input name="Qualify" type="text" class="form-control Qualification" placeholder="Qualification" value="<?php echo $row['Qualification']?>" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input name="Email" type="text" class="form-control Email" placeholder="Email" value="<?php echo $row['Email']?>" disabled>
                        </div>
                        <div class="form-group">
                            <input name="Gender" type="text" class="form-control Email" placeholder="Gender" value="<?php echo $row['Gender']?>" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <input name="ID" type="text" class="form-control cnic" placeholder="ID" value="<?php echo $row['ID']?>"disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input name="Password" type="text" class="form-control des" placeholder="Password" value="<?php echo $row['Password']?>" disabled>
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 text-right">
                        <a href="configure-teaching-staff.php" name="Back" class="btn btn-primary btn-sm add-button">Back</a>
                    </div>
                </div>
            </div>
