    ...
    <section id="add-teaching-staff" class="py-5">
        <div class="container">
            ...
            <form action="teacher-update.php" method="POST">
                ...
                $row = $res->fetch_assoc();
                ?>
                <h1 class="display-4 text-center mb-4">Edit Teacher Information</h1>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input name="Qualify" type="text" class="form-control Qualification" placeholder="Qualification" value="<?php echo $row['Qualification']?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input name="Email" type="text" class="form-control Email" placeholder="Email" value="<?php echo $row['Email']?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
