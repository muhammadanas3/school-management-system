        ...
        <div class="container">
            <div class="row m-auto">
                <div class="col-sm-6 my-3">
                    <div class="card">
                        ...
                        <div class="card-footer text-center">
                            <a href="student-register.php">Register Student</a>
                        </div>
                    </div>   
                </div>
                <div class="col-sm-6 my-3">
                    <div class="card">
                        ...
                        <div class="card-footer text-center">
                            <a href="configure-student.php">Configure Student info</a>
                        </div>
                    </div>   
                </div>
                <!-- <div class="col-sm-4 my-3">
                    <div class="card">
                        ...
                        <div class="card-footer text-center">
                            <a href="viewstudent.php">View Student info</a>
                        </div>
                    </div>   
                </div> -->
            </div>
            <!-- <div class="row">
                <div class="col-12 text-right">
                    <a href="admin.php" class="btn btn-primary btn-lg mt-4">Back</a>
                </div>
            </div> -->
