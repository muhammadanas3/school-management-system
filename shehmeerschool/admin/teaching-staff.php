...
<body>
    ...
    <nav class="navbar navbar-expand-sm sticky-top navbar-light bg-light mb-3">
        <div class="container">
            <a href="staff.php" class="mr-4"><i class="fas fa-arrow-left fa-2x text-dark"></i></a>
                ...
                <div class="col-sm-6 my-3">
                    <div class="card">
                        ...
                        <div class="card-footer text-center">
                            <a href="configure-teaching-staff.php">Configure teaching staff</a>
                        </div>
                    </div>   
                </div>
                <div class="col-sm-6 my-3">
                    <div class="card">
                        ...
                        <div class="card-footer text-center">
                            <a href="teacher-register.php">Register Teaching staff</a>
                        </div>
                    </div>   
                </div>
            </div>
